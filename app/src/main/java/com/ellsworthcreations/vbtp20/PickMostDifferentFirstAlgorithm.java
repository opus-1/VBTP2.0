...
public class PickMostDifferentFirstAlgorithm extends TeamPickingAlgorithm {
    public PickMostDifferentFirstAlgorithm(Context ctx, Player[] allPlayers, int numberOfTeams, boolean randomize, boolean forceEqualGenders) {
    ...
    public Player findPlayerRickAlgorithm(Team playerPool, Team team) {
        ...
        while (pitr.hasNext()) {
            ...
            double thisDistance = p1.distanceTo(this.context, team);
