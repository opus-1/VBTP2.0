...
public class PlayerDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (player != null) {
            if(player.isFemale())
            { ((RadioGroup) rootView.findViewById(R.id.gender_selection)).check(R.id.gender_female_id); }
            else
            { ((RadioGroup) rootView.findViewById(R.id.gender_selection)).check(R.id.gender_male_id); }
        }
